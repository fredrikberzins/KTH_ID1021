public class Sorting_Benchmark {
	...
	int[] sizes = {100,200,100,200,400,800,1600,3200,6400};
		...
		for ( int n : sizes) {
			System.gc();
			int loop = 1000;
			int[][] array2dOrgi = Sorting_Inital.array2d(loop, n);
			System.out.printf("%6d", n);
			int k = 1000;
			
			double min = Double.POSITIVE_INFINITY;
			for (int i = 0; i < k; i++) {
				int[][] array2dSection = Sorting_Inital.copyArr2d(array2dOrgi);
			...
			for (int i = 0; i < k; i++) {
				int[][] array2dInsert = Sorting_Inital.copyArr2d(array2dOrgi);
			...
			min = Double.POSITIVE_INFINITY;
			for (int i = 0; i < k; i++) {
				int[][] array2dMerge = Sorting_Inital.copyArr2d(array2dOrgi);
				long t0 = System.nanoTime();
			...
			min = Double.POSITIVE_INFINITY;
			for (int i = 0; i < k; i++) {
				int[][] array2dLowCopyMerge = Sorting_Inital.copyArr2d(array2dOrgi);
				long t0 = System.nanoTime();
